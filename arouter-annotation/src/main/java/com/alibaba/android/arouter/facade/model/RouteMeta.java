...
public class RouteMeta {
    private RouteType type;         // Type of route      路由的类型：
    private Element rawType;        // Raw type of route
    private Class<?> destination;   // Destination        目标Class
    private String path;            // Path of route      路径URL
    private String group;           // Group of route     分组
    private int priority = -1;      // The smaller the number, the higher the priority  路由的优先级
    private int extra;              // Extra data         目标Class的额外配置开关信息；譬如某些页面是否需要网络校验、登录校验等
    private Map<String, Integer> paramsType;  // Param type  目标Class的需要注入的参数 的参数名称：参数类型TypeKind
